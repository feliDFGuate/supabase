...
subtitle: 'Explore essential resources and guides to kickstart your journey with Supabase, from features to local development.'
hideToc: true
---
...
<div>
  ...
  <div className="grid grid-cols-12 gap-2 not-prose">
    {[
      {
        title: 'Features',
        hasLightIcon: true,
...
<div className="grid lg:grid-cols-12 gap-2 not-prose">
  {[
    {
